...
function App() {
	...
	const currentWeatherUrl = `https://api.openweathermap.org/data/2.5/weather?zip=${zipToSearch}&appId=${apiKey}&units=imperial`;
	const forecastWeatherUrl = `https://api.openweathermap.org/data/2.5/forecast?zip=${zipToSearch}&appId=${apiKey}&units=imperial`;
	...
	return (
		<div className='weather-app'>
			...
			{ curWeather.cod !== '404' && forecastWeather.cod !== '404' && (
				<Tile weather={curWeather} forecast={forecastWeather} />
			)}
		</div>
	);
}
